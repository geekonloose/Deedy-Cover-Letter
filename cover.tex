...
\lettercontent{Dear Prof. Carlo Fiorina,}
...
\lettercontent{I have carried out my Ph.D. in severe accident analysis with
    ...
    developed/used both Python based tools and modified OpenFOAM based solvers
    to analyze in-vessel, interface and in-containment source term. For
    in-vessel assessment, I have developed two tools namely i) percolation based
    mechanistic model to determine fission gas release \& pool scrubbing model
    and ii) thermo-chemical equilibrium approach based tool MINICHEM to
    determine RN release to cover gas. The fission gas release model would be
    not only helpful to determine gap release under accident conditions, but
    would be helpful to characterize or locate failed fuel elements during reactor operation.
    The developed tool was also used to specify allowable number of failed fuel
    elements during reactor operation for Prototype Fast Breeder Reactor (PFBR).
    MINICHEM is python based tool to analyze RN release to cover gas which is
    hosted
    \href{https://github.com/parthigcar/MINICHEM}{GitHub}.}

\lettercontent{For the interface and in-containment source term analysis, where the
    dynamics of aerosol evolution and release are of importance, I have
    developed a python based tool with a capability to analyze the aerosol evolution
    with time. This tool is available as an open source at 
    ...
    facilities) in order to have better understanding of aerosol evolution
    during
...
\lettercontent{I am extremely eager to pursue a post-doctoral research on
    challenging problems towards development of multiscale and multiphysics
    simulation for future generation reactors and related research topics. My
    formal training, academic background and research experience should permit
    me to carry out work in research problem related to safety analysis.
    % fission gas release, coupled
    % neutronic-thermal hydraulics problems and aerosol related problems
    My research interest matches with the work being carried out in your
    ...
    OpenFOAM. As an aspiring researcher I would assure that I will give my best
    and strive to provide innovative solutions to the tasks given to me and work
    hard in order to prove my self worthy. }
