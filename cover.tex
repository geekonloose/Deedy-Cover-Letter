...
\lettercontent{I have carried out my Ph.D. in severe accident analysis with
    ...
    developed/used both Python based tools and a modified OpenFOAM based solvers
...
\lettercontent{For the interface and in-containment source term analysis, where the
    ...
    with time. This is available as an open source at 
    ...
    facilities) in order to have better understanding of aerosol evolution during
...
\lettercontent{I am extremely eager to pursue a post-doctoral research on
    ...
    hard order to prove my self worthy. }
